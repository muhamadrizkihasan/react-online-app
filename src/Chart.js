...
function Chart() {
  ...
  const [isCheckout, setIsCheckout] = useState(false); // State untuk melacak status checkout
  ...
  const handleCheckout = () => {
    setIsCheckout(true); // Tandai bahwa checkout telah dilakukan
  };
              ...
              <Card className="shadow-sm">
                <Card.Body>
                  ...
                  <div className="d-flex justify-content-center">
                    <Button
                      variant={isCheckout ? "secondary" : "success"}
                      onClick={!isCheckout ? handleCheckout : undefined}
                      disabled={isCheckout}
                    >
                      {isCheckout ? "Preview Only" : "Proceed to Checkout"}
                    </Button>
                  </div>
                </Card.Body>
              </Card>
